...
-- EMPLOYEE 테이블에서 모든 사워의 사번, 이름, 급여, 연봉(급여 * 12) 조회
...
-- SYSDATE : 시스템상의 현재 시간(날짜)를 나타내는 방식
...
-- WHERE EMP_NAME LIKE '전__';   이건 이름이 3글자인 경우만 됨
