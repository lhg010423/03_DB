...
-- ORA-12899: "KH_LHG"."DEPT_COPY"."DEPT_ID" 열에 대한 값이 너무 큼(실제: 3, 최대값: 2)
...
-- DEPARTMENT 테이블에 PK 추가 (컬럼 : DEPT_ID, 제약조건명 : D_COPY_PK)
...
ROLLBACK;
SELECT * FROM TB2; -- COMMIT을 안한 상태에서 ROLLBACK을 했는데 안사라짐
