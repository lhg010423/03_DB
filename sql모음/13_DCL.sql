...
CREATE USER lhg_sample IDENTIFIED BY sample1234;


-- 2. 새 연결 추가
--> ORA-01045: 사용자 LHG_SAMPLE는 CREATE SESSION 권한을 가지고있지 않음; 로그온이 거절되었습니다
...
ALTER USER lhg_sample DEFAULT TABLESPACE
...
-- kh_lhg / lhg_sample 사용자 계정끼리 서로 객체 접근 권한 부여

-- 1. (sample) kh_lhg 계정의 EMPLOYEE 테이블 조회
